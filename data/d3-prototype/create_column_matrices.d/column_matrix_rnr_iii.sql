SELECT
  taxa.*,
  COALESCE(NrdDa.n_proteins,0) AS "protein:RNR IIIb:NrdDa:n_proteins",
  COALESCE(NrdDa.n_genomes_w_protein,0) AS "protein:RNR IIId:NrdDa:n_genomes_w_protein",
  ...
  COALESCE(NrdDf.n_proteins,0) AS "protein:RNR IIIh:NrdDf:n_proteins",
  COALESCE(NrdDf.n_genomes_w_protein,0) AS "protein:RNR IIIf:NrdDf:n_genomes_w_protein",
