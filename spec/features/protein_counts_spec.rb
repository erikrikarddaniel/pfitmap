...
describe "ProteinCounts" do
  ...
  before do
    50.times do |n|
      species = n.modulo(5)
      domain = n.modulo(2)
      FactoryGirl.create(:taxon, domain: "Tdomain#{domain}",kingdom: "Tkingdom", phylum: "Tphylum", taxclass: "Tclass", taxorder: "Torder",family: "Tfamily",genus: "Tgenus",species: "Tspecies#{species}", strain: "Tstrain#{n}")
    end
    @protein_counts = []
