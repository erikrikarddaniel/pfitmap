...
describe "protein_counts/new" do
  before(:each) do
    assign(:protein_count, stub_model(ProteinCount,
      :no_genomes => 1,
      :no_proteins => 1,
  ...
  it "renders new protein_count form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => protein_counts_path, :method => "post" do
