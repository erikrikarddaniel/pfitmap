...
describe "hmm_result_rows/edit" do
  before(:each) do
    @hmm_result_row = assign(:hmm_result_row, stub_model(HmmResultRow,
  ...
  it "renders the edit hmm_result_row form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => hmm_result_rows_path(@hmm_result_row), :method => "post" do
